	...
	const accordionData = [
		...
		},
		{
			...
			details: [
				...
				'то каждый звук вы можете сделать своим всего за 5-7 дней ежедневных тренировок'
			]
		},
		{
			id: 'panel3',
			...
			details: [
				'Я думаю вы заметили что я сделал все на русском:) Это я сделал для того чтобы мои курсы Американского произношения были доступны для всех уровней, и ПОТОМУ ЧТО ВСЕМ УРОВНЯМ АНГЛИЙСКОГО КОТОРЫЕ ЛЮДИ ИМЕЮТ НУЖНО ПРАВИЛЬНОЕ ПРОИЗНОШЕНИЕ! Без правильного произношения эти уровни фальшивые. Да, и у вашего учителя английского и друга/подруги которые хвастаются своим английским, произношение скорее всего плохое и звучит для ушей носителей, и не только, ужасно. ',
				'А переучивать свое плохое произношение на правильное намного сложнее чем учить правильное сначала. Поэтому если у вас нулевой уровень английского, это ШИКАРНО! И вам поскорее пройти мой курс пока вас не испортили'
			]
		},
		{
			id: 'panel4',
		...
		},
		{
			...
			details: [
				...
				'Вы можете посмотреть бесплатную часть курса чтобы понять, подойдет ли курс вам.'
			]
		}
	]
