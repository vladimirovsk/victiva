			...
			<div className={'titlePageCursWhiteText'} style={{textShadow: '-1px -1px 0 #000, 2px -1px 0 #000, -1px 2px 0 #000, 2px 2px 0 #000'}}>
				...
				<Grid container spacing={3} columns={12} direction="row" style={{
					...
					<Grid size={{lg:4, md:6, sm:12, xs:12}} style={{
						...
						<div style={{ marginBottom: '20px' }}>русскоязычные люди НЕПРАВИЛЬНО ПРОИЗНОСЯТ</div>
						<div style={{ marginBottom: '20px' }}>✔ 9 супер видео тренировок для каждого звука</div>
						<div style={{ marginBottom: '20px' }}>✔ 1000 + слов где используется каждый звук</div>
						...
						<div style={{ marginBottom: '20px' }}>✔ Специальные упражнения для языка и мышц рта</div>
				...
				<Grid container spacing={3} columns={12} direction="row" style={{
					...
					<Grid size={{lg:4, md:6, sm:11, xs:11}} style={{
						...
						<div style={{lineHeight: 1.6}}>Если вы пробовали проходить курс и вам по любой причине он
							не подошел, вам деньги возвращаются в течение
